...
// *********************************************************************
{
  ...
  char buf[20];
  sprintf (buf, "%d: %s", current_scene, scenes[current_scene].name);
...
void mDyn_C_Offset(uint8_t line)
// *********************************************************************
{
  // check if this function is active (cursor stands on this line)
  if (line == LCDML.MENU_getCursorPos())
  ...
  char buf[20];
  sprintf (buf, "C Offset: %d", coarse_offset);
